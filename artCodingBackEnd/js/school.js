...
$(function(){
		...
		$("body").on("mouseover","div[class='schoolList'] ul li",function(){
			console.log("1");
		...
		$("body").on("mouseout","div[class='schoolList'] ul li",function(){
		...
		$("body").on("click","div[class='schoolList'] ul li",function(){
		...
		$("body").on("click","div[class='button'] button",function(){
